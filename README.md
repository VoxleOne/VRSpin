...
**Every entity is a node in $S^3$, not an object in coordinate space**. Every perceivable thing in the scene is guarded by a **SpinStep attention cone**.
...
> children. That means no position, no scale, no transform hierarchy. Traversal, proximity,
